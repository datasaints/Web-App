...
<body class="hold-transition skin-blue sidebar-mini" ng-app="DataSaints">
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div id="status-widgets" 
     		ng-include="'pages/top-widgets.html'">
		</div>
